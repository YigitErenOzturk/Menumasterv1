...
const handleRestaurantSignup = async (event) => {
    ...
    try {
        ...
        // Supabase Auth + PostgreSQL service.
        const response = await restaurantService.register(restaurantData);

        // Service completed successfully.
        messageEl.textContent = response.data?.requiresEmailConfirmation
            ? 'Restaurant registered! Check your email to confirm the account.'
        ...
        // Service errors are caught here.
